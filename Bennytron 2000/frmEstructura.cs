    ...
    public partial class frmEstructura : Form
    {
        ...
        private void frmEstructura_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                txtGradosInclinacion.Text = "5"; // Text = _nucleo.Parametro("txtGradosInclinacion.Text");
            }
            catch (Exception ex)
            {
        ...
        private void Actualizar()
        {
            try
            {
                ...
                */
                ...
                int segmentos = int.Parse("0" + txtSegmentosPanel.Text);
        ...
        private void frmEstructura_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                ...
                Se inhabilitó por que no está guardando en la base de datos
